                            ...
                            <li class="media">
                                <a href="{{ url('gaji/detail/1') }}">
                                  <div class="media-body">
                                      <div class="media-right">Rp. 10.000.000</div>
                                      <div class="media-title"><a href="#">Gaji Periode Januari 2023</a></div>
                                      <div class="text-muted text-small">Dikirim <a href="#">24-05-2023 08:10:00</a> <div class="bullet"></div> Terkirim</div>
                                    </div>
                                </a>
                            </li>
                          </ul>
