    ...
    <script>
        $(function() {
            ...
            $('#savepekerjaan').click(function(e) {
                ...
                $.ajax({
                    ...
                    url: "{{ url('profile/tambah_pekerjaan') }}",
                    type: "POST",
                    dataType: 'json',
                    // dataType: 'json',
                    success: function(data) {
            ...
            $('#savepelatihan').click(function(e) {
                ...
                $.ajax({
                    ...
                    data: data,
                    url: "{{ url('profile/tambah_pelatihan') }}"+'?_token=' + '{{ csrf_token() }}',
                    type: "POST",
        ...
        function hapuspekerjaan(id) {
            if(confirm('Apakah anda yakin ingin di hapus?')){
                $.ajax({
                    type: 'get',
                    url: "{{ url('profile/hapus_pekerjaan') }}/" + id,
                    // data:{'id':id}, 
                    success: function(tampil) {
                        iziToast.success({
                            title: 'Selamat',
        ...
        function hapuspelatihan(id) {
            if(confirm('Apakah anda yakin ingin di hapus?')){
                $.ajax({
                    type: 'get',
                    url: "{{ url('profile/hapus_pelatihan') }}/" + id,
                    // data:{'id':id}, 
                    success: function(tampil) {
                        iziToast.success({
                            title: 'Selamat',
        ...
        function tableRiwayatPekerjaan(id){
            $.ajax({
                type: 'get',
                url: "{{ url('profile/table_riwayat_pekerjaan') }}/" + id,
                // data:{'id':id}, 
                success: function(tampil) {
        ...
        function tablePelatihan(id){
            $.ajax({
                type: 'get',
                url: "{{ url('profile/table_pelatihan') }}/" + id,
                // data:{'id':id}, 
                success: function(tampil) {
