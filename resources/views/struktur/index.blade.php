                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($struktur as $item)
                                        <tr class="bg-info">
                                            <td>
                                                <h5 class="text-white">{{ strtoupper($item['nama_struktur']).' | '. $item['akronim'] }}</h5>
                                                @if ($item['parent_id'] == 0)
                                                @else
                                                    <h5 class="text-primary">
                                                        {{ strtoupper($item['nama_struktur']).' | '. $item['akronim'] }}</h5>
                                                @endif
                                            </td>
                                            <td>
                                        ...
                                        <tr class="bg-primary">
                                            <td>
                                                <h5 class="text-white">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ strtoupper($substruktur['nama_struktur']).' | '. $substruktur['akronim'] }}</h5>
                                            </td>
                                            <td>
                                            ...
                                            <tr class="bg-success">
                                                <td>
                                                    <h5>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ strtoupper($substruktur1['nama_struktur']).' | '. $substruktur1['akronim'] }}</h5>
                                                </td>
                                                <td>
                                                ...
                                                <tr class="bg-secondary">
                                                    <td>
                                                        <h5>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ strtoupper($substruktur2['nama_struktur']).' | '. $substruktur2['akronim'] }}</h5>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <h5>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ strtoupper($substruktur3['nama_struktur']).' | '. $substruktur3['akronim'] }}</h5>
                                                        </td>
                                                        <td>
